  ...
  <div class="<?php print $container_class; ?>">
    <div class="navbar-header">
      <div class="owners">
        <?php if ($logo): ?>
          <div>
          <a class="logo navbar-btn" href="https://libraries.uta.edu" title="<?php print t('UTA Libraries'); ?>">
            <img src="<?php print $logo; ?>" alt="<?php print t('UTA Libraries and Center for Greater Southwestern Studies'); ?>" />
          </a></div>
        <?php endif; ?>
      </div>
