L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
		...
		$(sliderContainer).append('<div id="settings-control"><img id="custom-settings" src="//library.uta.edu/borderland/sites/all/themes/borderland_sass/images/settings_slider.png" alt="" data-toggle="tooltip" data-placement="left" title="Click settings to change animation">settings (select race, tribe, or time range)</div>');
										...
										if(_options.markers[i].feature !== undefined) {
										   ...
										   if(tribeFeature!="All" && raceFeature =="All" ) {
											...
											if(raceFeature!="All" && tribeFeature =="All") {
												console.log("Got racefeature.."+raceFeature);
