								   ...
								   for (var ftrs in matchFeatures){
										   if(_options.markers[i].feature.properties.Tribe.replace(regex,"").includes(matchFeatures[ftrs])){
												...
												var statehoodIcon = L.icon({iconUrl: '//library.uta.edu/borderland/sites/default/files/marker/1845-Statehood.png',
													...
													'<strong>Race or Ethnicity: </strong>'+_options.markers[i].feature.properties.EthnicGroup+'<br>'+'<strong>Tribe: </strong>'+_options.markers[i].feature.properties.Tribe+'<br>'+'<br>'+'<strong>Event Type: </strong>'+_options.markers[i].feature.properties.EventType);
									...
									var statehoodIcon = L.icon({iconUrl: '//library.uta.edu/borderland/sites/default/files/marker/1845-Statehood.png',
										...
										_options.markers[i].bindPopup('<a href="/borderland/event/'+_options.markers[i].feature.properties.Nid+'">'+_options.markers[i].feature.properties.name+'</a>'+'<br><br>'+_options.markers[i].feature.properties.Date+'<br>'+
										_options.markers[i].feature.properties.description+'<br><br>'+'<strong>Time Period: </strong>'+'<a href="/borderland/period/'+timeString+'">'+_options.markers[i].feature.properties.timePeriod+'</a>'+'<br>'+
										'<strong>Race or Ethnicity: </strong>'+_options.markers[i].feature.properties.EthnicGroup+'<br>'+'<strong>Tribe: </strong>'+_options.markers[i].feature.properties.Tribe+'<br>'+
    ...
    startSlider: function () {
        ...
        for (i = _options.minValue; i <= index_start; i++) {
			...
			var statehoodIcon = L.icon({iconUrl: '//library.uta.edu/borderland/sites/default/files/marker/1845-Statehood.png',
    							...
    							_options.markers[i].bindPopup('<a href="/borderland/event/'+_options.markers[i].feature.properties.Nid+'">'+_options.markers[i].feature.properties.name+'</a>'+'<br><br>'+_options.markers[i].feature.properties.Date+'<br>'+
                               	_options.markers[i].feature.properties.description+'<br><br>'+'<strong>Time Period: </strong>'+'<a href="/borderland/period/'+timeString+'">'+_options.markers[i].feature.properties.timePeriod+'</a>'+'<br>'+'<strong>Race or Ethnicity: </strong>'+_options.markers[i].feature.properties.EthnicGroup+'<br>'+
